...
export default function WelcomePage() {
  //scrollY number of pixles user scrolled vertically
  const { scrollY } = useScroll();

  const yCity = useTransform(scrollY, [0, 200, 300], [0, -100, -200]);
  //when the user is at 0 (hasn't scrolled yet, opacity is 1, when the user scrolls 200px, opacity becomes 0.5) and so on.
  ...
  const yHero = useTransform(scrollY, [0, 200, 300], [0, -150, -250]);
