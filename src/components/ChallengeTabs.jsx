...
function Tab({ isSelected, onSelect, badgeCaption, children }) {
  return (
    <li>
      ...
      >
        {children}
        {/* we add the key here and then change it to get react to recreate this element which will retrigger the animation we defined */}
        <Badge key={badgeCaption} caption={badgeCaption}></Badge>
      </button>
      {isSelected && (
        //with layoutId added, motion will aanimate this bar as if its moving when we switch tabs
